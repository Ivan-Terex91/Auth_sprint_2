...
ns = Namespace("Authorization Namespace", authorizations=authorizations, security="api_key")
...
class GetUserRoles(Resource):
    @login_required
    @is_superuser
    @ns.marshal_with(ResponseGetUserRoles, code=200, description="Successfully getting user roles")
