...
class CaptchaService:
    ...
    def get(self, id: UUID) -> CaptchaChallenge:
        ...
        if captcha_challenge.exp.replace(tzinfo=timezone.utc) < datetime.now(tz=timezone.utc):
    ...
    def delete(self, id: UUID):
        return self.session.query(CaptchaChallenge).filter(CaptchaChallenge.id == id).delete()
